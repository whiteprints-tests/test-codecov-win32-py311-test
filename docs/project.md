...
The project is hosted on [https://github.com/whiteprints-tests/test-codecov-win32-py311-test.git](https://github.com/whiteprints-tests/test-codecov-win32-py311-test.git).
